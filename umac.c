 ...
 *
 * Permission to use, copy, modify,u and distribute this software and
...
#define UMAC_OUTPUT_LEN       MAC_LEN  /* Alowable: 4, 8, 12, 16              */
#define FORCE_C_ONLY          0  /* ANSI C and 64-bit integers req'd     */
...
#else
#define __LITTLE_ENDIAN__ 1 // TODO We set LITTLE_ENDIAN for all cases, since Re-Motes are not detected automatically. This needs to be addressed at some point
#endif
#endif
...
#define aes_encryption(in,out,int_key) \
	    rijndaelEncrypt((uint32_t *)(int_key), AES_ROUNDS, (uint8_t *)(in), (uint8_t *)(out))
#define aes_key_setup(key,int_key) \
	    rijndaelKeySetupEnc((uint32_t *)(int_key), (const unsigned char *)(key), \
	    UMAC_KEY_LEN*8)
#endif
